class CompanyTicketsController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @ticket.save
        format.html { redirect_to company_tickets_url(@current_company.sub_domain), notice: 'Ticket was successfully created.' }
  ...
  def update
    respond_to do |format|
      if @ticket.update(company_ticket_params)
        format.html { redirect_to company_tickets_url(@current_company.sub_domain), notice: 'Ticket was successfully updated.' }
  ...
  def destroy
    @ticket.destroy
    respond_to do |format|
      format.html { redirect_to company_tickets_url(@current_company.sub_domain), notice: 'Ticket delete successfully.' }
      format.json { head :no_content }
    end
  end
